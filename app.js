...
mongoose.connect(`mongodb+srv://admin-muskan:${process.env.MONGOP}@cluster0.f6jpr.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`, {useNewUrlParser: true, useUnifiedTopology: true});
